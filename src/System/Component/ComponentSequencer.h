...
class SequenceObject: public IMatrix<SequenceObject> {
   public:
    ...
    virtual std::shared_ptr<SequenceObject> SharedThis() {
        return nullptr;
    }
   ...
   public:
    ...
    std::string GetNameLabel() {
        return "NAME##name" + std::to_string(reinterpret_cast<uint64_t>(this));
    }
   ...
   private:
    ...
    CEREAL_SAVELOAD(arc, ver) {
        ...
        arc(CEREAL_NVP(open_),    //
            ...
            CEREAL_NVP(position_values_), CEREAL_NVP(rotation_values_), CEREAL_NVP(scale_values_), CEREAL_NVP(animation_keys_),
            CEREAL_NVP(animation_values_), CEREAL_NVP(scale_values_), CEREAL_NVP(scale_values_), CEREAL_NVP(animation_name_),
            CEREAL_NVP(animation_frame_old_), CEREAL_NVP(animation_frame_), CEREAL_NVP(animation_change_),
            CEREAL_NVP(animation_loop_), CEREAL_NVP(effect_number_), CEREAL_NVP(effect_frame_old_), CEREAL_NVP(effect_frame_),
