...
#pragma warning(disable: 26813)
            ...
            if (grp == CollisionGroup::WALL) return "WALL";
            if (grp == CollisionGroup::GROUND) return "GROUND";
            if (grp == CollisionGroup::PLAYER) return "PLAYER";
            if (grp == CollisionGroup::ENEMY) return "ENEMY";
            if (grp == CollisionGroup::WEAPON) return "WEAPON";
            if (grp == CollisionGroup::ITEM) return "ITEM";
            if (grp == CollisionGroup::CAMERA) return "CAMERA";
            if (grp == CollisionGroup::ETC) return "ETC";
