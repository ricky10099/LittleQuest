...
void Rock2::Update()    // override
{}

// 基本描画の後に処理します
void Rock2::LateDraw()    // override
{}

void Rock2::GUI()    // override
{
    Super::GUI();
}

void Rock2::OnHit([[maybe_unused]] const ComponentCollision::HitInfo& hitInfo)    // override
{
    Super::OnHit(hitInfo);
}
}    // namespace LittleQuest
